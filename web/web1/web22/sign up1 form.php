...
<body>
	...
	<div class="sub-main-w3">
		<form name="frm" validate="true" action="signup2.php" method="post">
			<h2>Sign up here</h2>
			<div class="form-group">
				<label for="exampleInputText">Laboratory Name</label>
				<input type="text" class="form-control" name="laboratoryname" id="exampleInputText" autocomplete="off" placeholder="Enter Laboratory Name" required="required" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32))' pattern="^[^\s]">
			</div>
			<div class="form-group">
