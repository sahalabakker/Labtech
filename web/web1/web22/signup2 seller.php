...
<body>
	...
	<div class="sub-main-w3">
		<form name="frm" validate="true" action="userprofile seller.php" method="post">
			<h2></h2>
			<!--<div class="form-group">
				<label for="exampleInputText">Proffession</label>
				<input type="text" class="form-control" name="proffession" id="exampleInputText" autocomplete="off" placeholder="Proffession" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32))' required pattern="^[^\s]">
			</div>
			<div class="form-group">
				<label for="exampleInputText">Experience</label>
				<input type="text" class="form-control" name="experience" id="exampleInputText" autocomplete="off" placeholder="Experience" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32))' required pattern="^[^\s]">
			</div>-->
			<div class="form-group">
