...
$selectb="select * from bioengineer where email='$laboratoryname'";
$result=$ob->db_read($selectl);
$resultss=$ob->db_read($selects);
$resultb=$ob->db_read($selectb);
$arr=mysqli_fetch_array($result);
$arr1=mysqli_fetch_array($resultss);
$arr2=mysqli_fetch_array($resultb);
...
if($usertype=='bioengineer' && $arr2['status']=='1') {
...
?>
    ...
    <div class=" w3l-login-form">
        ...
        <form action="" method="POST">
           ...
           echo $message
            ...
            <div class="forgot">
                ...
                <a data-toggle="modal" data-target="#myModal"><font color="white">Forgot password?</font></a>
        ...
        <p class=" w3l-register-p">Don't have an account?<a data-target="#myModall" data-toggle="modal" id="MainNavHelp" href=""> Sign up</a></p><div id="myModall" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <!--modal content-->
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <a href="web22/sign up1 form.php">
                                <img src="../images/iconmdlab.png" alt="Avatar" class="avatar" style="vertical-align: middle; width: 130px; height: 130px; border-radius: 60%;"></a>&nbsp &nbsp &nbsp &nbsp
                            <a href="web22/sign up1 form bioengineer.php">
                                <img src="../images/bio1.jpg" alt="Avatar" class="avatar"  style="vertical-align: middle; width: 130px; height: 130px; border-radius: 60%;"></a>&nbsp &nbsp &nbsp &nbsp
                            <a href="web22/sign up1 form seller.php">
                                <img src="../images/worker.png" alt="Avatar" class="avatar"  style="vertical-align: middle; width: 130px; height: 130px; border-radius: 60%;"></a>&nbsp &nbsp &nbsp &nbsp
