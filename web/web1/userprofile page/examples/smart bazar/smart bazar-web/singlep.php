...
<body>
	<?php
	{
		...
		if(isset($_POST['cart'])) {
			...
			$premail=$email;
			$q1="select * from cart where product_id='$productid' and lab_email='$premail'";
			$t1=$ob->db_read($q1);
			if(mysqli_num_rows($t1))
			{
				?>
				<script>
			...
			$insertca="insert into cart (product_id,product_name,product_code,category,company,amount,offer,lab_email,seller_email) values ('$productid','$prname','$prcode','$prcategory','$prcompany','$pramount','$proffer','$premail','$prseller')";
	...
	<div class="header">
		...
		<div class="header-three"><!-- header-three -->
			<div class="container">
				...
				<div class="move-text">
					<div class="marquee"><a href="">  Well experienced Biomedical engineers are available here...... <span></span> <span></span></a></div>
			...
			<div class="single-page">
				<!--<div class="single-page-row" id="detail-21">-->
						...
						<!--<div class="flexslider">-->
							<ul class="slides">
								<li data-thumb="images/s1.jpg">
									<div class="thumb-image detail_images"> <img src="./images/<?php echo $arr['photo']; ?>" style="width: 300px; height: 300px;" class="img-responsive" alt=""> </div>
								</li>
					...
					<div class="col-md-6 single-top-right">
						<?php echo('<h3 class="item_name">'.$arr['product_name'].'</h3>');
						echo("<br>");
						 echo('<p>Product Code: '.$arr['product_code'].'</p>');
						 echo('<p>'.$arr['category'].'</p> ');
						 echo('<p>'.$arr['company'].' PVT LTD</p> ');
						...
						echo('<ul>');
						echo('<li><p style="color:#ff0000;">'.$arr['offer'].' % OFF</p></li>');
						echo("       ");
						echo('<li><h4>      $'    .$arr['amount'].'</h4></li>');
						echo("  ");
						echo('<li><p> Only '.$arr['stock'].' are available</p></li>');
						echo('</ul>');
						//echo('</div>');
						?>
						...
						//echo('<form action="" method="post">');
							...
							echo('<a href="address.php?id1='.$arr['product_id'].'">');
							echo('<input type="submit" value="Buy now" class="w3ls-cart" style="background-color: #ff4433;">');
						echo('</a>');
						//echo('</form>');
						//echo('<button class="w3ls-cart w3ls-cart-like"><i class="fa fa-heart-o" aria-hidden="true"></i> Add to Wishlist</button>');
						echo("   ");
						//echo('<a href="add to cart.php?id='.$arr['product_id'].'">');
						echo('<form action="" method="post">');
						echo('<input type="submit" class="w3ls-cart" name="cart" value="Add to cart">');
						echo('</form>');
					echo('</div>');
					?>
				   <div class="clearfix"> </div>
