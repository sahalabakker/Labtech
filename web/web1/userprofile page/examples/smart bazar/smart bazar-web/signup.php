...
<body>
	...
	$eq=$_POST['equipment'];
	$insert="insert into complaint(book_date,equip,complaint,lab_email,bioengineer_email) values ('$date','$eq','$complaint','$email','$bio_email')";
	$ob->db_write($insert);
	?>
	<script>
		alert("post complaint successfully");
	</script>
	<?php
}
	...
	<div class="header">
		<div class="w3ls-header"><!--header-one--> 
			<div class="w3ls-header-left">
				<p style="color: #fff;">Experienced Biomedical enineers | </p>
			</div>
		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				<div class="header-logo">
					...
					<h6>Your biomedical enineers.your place.</h6> 
				</div>	
	...
	<div class="login-page">
		<div class="container"> 
			<h3 class="w3ls-title w3ls-title1">Post Your Complaint</h3> 
			<div class="login-body">
				...
				<input type="text" class="user" name="equipment" placeholder="complained equipment" required="" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' >
					<input type="submit" name="submit" value="Post Complaint ">
