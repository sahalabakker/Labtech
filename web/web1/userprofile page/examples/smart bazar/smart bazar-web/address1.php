...
$cmplid=$_GET['id1'];
$_SESSION['cmplid']=$cmplid;
$email=$_SESSION['email'];
//$bemail=$_SESSION['bio_email'];
...
$pin=$arr1['pin_code'];
$sel2="select * from complaint where complaint_id='$cmplid'";
$res2=$ob->db_read($sel2);
$arr2=mysqli_fetch_array($res2);
//$selleremail=$arr2['seller_email'];
$complaint=$arr2['complaint'];
$amount=$arr2['amount'];
$equip=$arr2['equip'];
$date=$arr2['book_date'];
$bemail=$arr2['bioengineer_email'];
/*$offer=$arr2['offer'];
...
$insert="insert into payment(complaint_id,equip,book_date,amount,lab_name,street,city,district,state,country,contact,pincode,complaint,lab_email,bioengineer_email) values ('$cmplid','$equip','$date','$amount','$labname','$street1','$city1','$district1','$state1','$country1','$contact1','$pin','$complaint','$email','$bemail')";
$res4=$ob->db_write($insert);


?><script>
	alert("Address details upload successfully");
	window.location='payment-web/index1.php'
</script>;
<?php
}
?>
...
<div class="header-bottom-w3ls">
	...
	<form action="#" method="post" name="form">
					...
					<table border="2" align="center" class="t1"><tr><th colspan="8" style="text-align: center; background:  rgba(0, 0, 0, 0.4);">
					PRODUCT DETAILS</th></tr>
				
					
						<tr style="height:70px;background: rgba(0, 0, 0, 0.4);">
							<th>Complaint ID</th>
							<th>Complained Equipment</th>
							<th>Complaint</th>
							<th>Booked Date</th>
							
							<th>Total amount</th>
						</tr>
						<tr bgcolor="white" style="height:70px;"><td><?php echo $cmplid?> </td>
<td><?php echo $equip?></td>
<td><?php echo $complaint?></td>
<td><?php echo $date?></td>
<td><?php echo $amount?></td></tr>
<tr><th colspan="8" style="height:50px; text-align: center;background: rgba(0, 0, 0, 0.4);">DELIVERY ADDRESS</th></tr>
<tr ><td bgcolor="white">
