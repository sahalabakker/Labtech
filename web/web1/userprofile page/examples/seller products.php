...
<body>
	...
	<div class="header">
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				<ul>
					...
					<li class="dropdown head-dpdn">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-percent" aria-hidden="true"></i>  Deals<span class="caret"></span></a>
						<ul class="dropdown-menu">
		...
		<!--<div class="header-three"><!-- header-three -->
			...
			<div class="container">
				<div class="move-text">
					<div class="marquee"><a href="offers.html"> <b>Here is best sale for your laboratory products... <span>Big sales for your products..</span> <span></span></b></a></div>
						...
						//echo("<img class=img src=".$photo."</a>");
							...
							echo('<span class="fa fa-star"></span>');
								...
								/*echo("<form action=# method=post>");
									...
									echo("<br>");*/
								    echo('<a href=productsingle.php?email1='.$row['product_id'].'>');
								    echo('<button type="submit" class="w3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i>Add to cart</button>');
						...
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								...
								<form action="#" method="post">
									...
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Book Bioedical engineer</button>
								</form>
							</div>
						</div>
					</div>
