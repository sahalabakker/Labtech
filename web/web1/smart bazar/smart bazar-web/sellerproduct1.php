...
<body>
	...
	$insert="insert into product(product_name,product_code,category,company,stock,amount,offer,photo,seller_email) values ('$name','$code','$category','$company','$stock','$amount','$offer','$photo','$email')";
	$ob->db_write($insert);
}
?>
<?php
	$update1="update product SET product_name='$name',product_code='$code',category='$category',company='$company',stock='$stock',amount='$amount',offer='$offer',photo='$photo' where seller_email='$email'";
  ...
  $sel="select * from product where seller_email='$email'";
  ...
  $photo=$arr['photo'];
	...
	<div class="header">
		<div class="w3ls-header"><!--header-one--> 
			<div class="w3ls-header-left">
				<p><a href="#">Efficient platform for laboratory equipment sales |  </a></p>
			</div>
	...
	<div class="login-page" style="width: 100%;">
		<div class="container" style="width: 95%;height: 95%;"> 
			<h3 class="w3ls-title w3ls-title1">Upload Your Products</h3> 
			...
			<div class="login-body">
				<form validate="true" action="" method="post">
					...
					<input type="text" class="user" name="productname" placeholder="Product Name" required="" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' value="<?php echo $arr['product_name'] ?>" >

					<input type="text" class="user" name="productcode" placeholder="Product Code" required="" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' >

					<input list="exampleInputTextse" type="text" class="user" name="category" id="exampleInputText" autocomplete="off" placeholder="Product Category" required>
				<datalist id="exampleInputTextse">
					...
					<input type="text" class="user" name="company" placeholder="Company Name Of Product" required="" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' >

					<input type="text" class="user" name="stock" placeholder="Available Stock" required="" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' >

					<input type="text" class="user" name="amount" placeholder="Amount" required="" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' >

					<input type="text" class="user" name="offer" placeholder="Offer In %" required="" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' >
				...
				<input type="file" class="user" name="photo" placeholder="Product Photo" required="" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' >
			<br>
