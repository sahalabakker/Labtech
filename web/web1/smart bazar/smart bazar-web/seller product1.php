		...
		<div class="container" style="width: 95%;height: 95%;"> 
			...
			<div class="login-body">
				<form validate="true" action="" method="post">
					...
					<input type="text" class="user" name="productname" placeholder="Product Name" required="" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' >
