...
<body>
	...
	$abservice=htmlspecialchars($_POST['aboutservice']);
	$amount=$_POST['amount'];
	$insert="insert into service(service_name,email,about_service,amount) values ('$servicename','$email','$abservice','$amount')";
	$ob->db_write($insert);
	?>
	<script>
	...
	<div class="header">
		...
		<div class="header-three"><!-- header-three -->
			<div class="container">
				...
				<div class="move-text">
					<div class="marquee"><a href="offers.html"> Add Your Services...... <span> </span> <span> The Service Will Be Visible On laboratories.</span></a></div>
	...
	<div class="login-page">
		<div class="container"> 
			<h3 class="w3ls-title w3ls-title1">Add Your Service</h3> 
			<div class="login-body">
				<form validate="true" action="" method="post">
					...
					<input type="text" name="servicename" class="user" placeholder="service" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))' required="">
					<label for="service" name="aboutservice" class="user textarea" placeholder="About service" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode==32) || (event.charCode >=48 && event.charCode <= 57))'>
					<textarea id="textarea" class=" " name="aboutservice" rows="4" cols="70" required=""> about service
					</textarea>
				
				<input type="text" class="user" name="amount" placeholder="amount" required="" onkeypress='return((event.charCode==32) || (event.charCode==36) || (event.charCode >=48 && event.charCode <= 57) || (event.charCode==45))'>
					<input type="submit" name="service" value="Add service ">
