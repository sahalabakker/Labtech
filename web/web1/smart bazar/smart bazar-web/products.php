				...
				<div class="header-cart"> 
					...
					<div class="cart"> 
						<form action="#" method="post" class="last"> 
							...
							<button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-calendar-minus-o" aria-hidden="true"></i></button>
						</form>  
					</div>
					<div class="clearfix"> </div> 
				</div> 
				...
				<div class="products-row">
					...
					echo("<div class=col-md-3 product-grids>");
						...
						echo ("<div class=team-img>");
							...
							echo('<img bgcolor="black" src="'.$row1['photo'].'"alt="img" class="center" style="width: 200px;height: 200px;data-background-color: white;"></a>');
